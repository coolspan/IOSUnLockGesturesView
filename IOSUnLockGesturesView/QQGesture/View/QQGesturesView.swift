...
class QQGesturesView: UIView {
    ...
    private var pointViews = [QQPointView]()
...
private extension QQGesturesView {
    ...
    func initSubviews(frame: CGRect) {
        ...
        for index in 0 ..< 9 {
            ...
            let pointView = QQPointView(frame: CGRect(x: x, y: y, width: pointWidth, height: pointWidth), id: index)
